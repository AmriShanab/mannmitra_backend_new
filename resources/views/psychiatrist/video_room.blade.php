...
<head>
    ...
    <style>
        ...
        .video-container { position: relative; height: 85vh; width: 100%; display: flex; justify-content: center; }
        #remoteVideo { width: 100%; height: 100%; object-fit: cover; background: #1E293B; border-radius: 12px; }
        #localVideo { 
            position: absolute; bottom: 20px; right: 20px; 
            width: 200px; height: 150px; 
            object-fit: cover; border-radius: 8px; border: 2px solid #0D9488; background: #000;
        }
        .controls { height: 15vh; display: flex; align-items: center; justify-content: center; gap: 20px; }
        .btn-control { width: 50px; height: 50px; border-radius: 50%; border: none; font-size: 20px; }
